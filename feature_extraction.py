...
class Feature_Extractor:
    ...
    def __init__(self):        
        self.types_dict = {}
        self.descriptive_stats_keywords = ['R-square','p-value','P-value','t-stat','median','mode','variance','STD Error','confidence','interval','range','Standard Deviation','Percentiles','Descriptive Statistics','Statistics','Coefficient','Count','Coef','average','avg','min','max','maximum','minimum','Variation']
        self.variable_definition_keywords = ['Definitions','definition','description','Explanation','Description']
    ...
    def check_cols_descriptive_stats(self):
        cleaned_list = [x for x in self.df.iloc[0,:].tolist() if str(x) != 'nan'] 
